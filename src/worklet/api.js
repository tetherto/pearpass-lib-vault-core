export const API = {
  ...
  REMOVE_VAULT: 63,
  ON_MASTER_UPDATE: 64,
  PERSONAL_SWARM_INIT: 65,
  PERSONAL_SWARM_CLOSE: 66,
  PERSONAL_SWARM_GET_TOPIC: 67,
  PERSONAL_SWARM_SEND: 68,
  ON_PERSONAL_SWARM_ENVELOPE: 69,
  MASTER_VAULT_REMOVE: 70,
  MASTER_VAULT_FIND: 71
}
